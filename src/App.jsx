...
export default function App() {
  ...
  // Common styling for strict black borders mimicking a printed form
  ...
  return (
    <Box sx={{ minHeight: '100vh', backgroundColor: '#e0e0e0', py: 4, display: 'flex', justifyContent: 'center' }}>
      {/* Paper container to act as an A4 page */}
      <Paper 
        elevation={4} 
        sx={{ 
          width: '100%', 
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell width="30%" sx={{ '&.MuiTableCell-root': { p: 0, verticalAlign: 'top' } }}>
                  {/* Replicated stacked box format matching the uploaded image */}
...
//                 <TableRow>
//                   <TableCell sx={{ py: 1 }}>
//                     <Typography variant="caption" display="block" sx={{ fontWeight: 'bold' }}>Doc. No.: UGES-MR-F-19</Typography>
//                   </TableCell>
//                 </TableRow>
//                 <TableRow>
//                   <TableCell sx={{ py: 1 }}>
//                     <Typography variant="caption" display="block" sx={{ fontWeight: 'bold' }}>Rev. No.: 00</Typography>
//                   </TableCell>
//                 </TableRow>
//                 <TableRow>
//                   <TableCell sx={{ py: 3 }}>
//                     <Typography variant="caption" display="block" sx={{ fontWeight: 'bold' }}>Eff. Dt.: 01/08/2020</Typography>
//                   </TableCell>
//                 </TableRow>
//                 <TableRow>
//                   <TableCell sx={{ py: 1 }}>
//                     <Typography variant="caption" display="block" sx={{ fontWeight: 'bold' }}>Page 1 of 1</Typography>
//                   </TableCell>
//                 </TableRow>
//               </TableRow>
//             </TableBody>
...
//             <TableBody>
//               <TableRow>
//                 <TableCell align="center">Not up to the mark <br/> <b>2</b></TableCell>
//                 <TableCell align="center">Poor <br/> <b>4</b></TableCell>
//                 <TableCell align="center">Acceptable <br/> <b>6</b></TableCell>
//                 <TableCell align="center">Meeting Expectations <br/> <b>8</b></TableCell>
//                 <TableCell align="center">Exceeding Expectations <br/> <b>10</b></TableCell>
//               </TableRow>
//             </TableBody>
//           </Table>
//         </TableContainer>
...
//                   <Box display="flex" alignItems="flex-end">
//                     <Typography variant="body2" fontWeight="bold">Average of overall Feedback:</Typography>
//                     <Box sx={{ ml: 2, borderBottom: '1px solid black', width: '150px', mb: 0.5 }} />
//                   </Box>
//                 </TableCell>
//               </TableRow>
//             </TableBody>
...
//           <Box display="flex" alignItems="flex-end" sx={{ mb: 3 }}>
//             <Typography variant="body2" fontWeight="bold">Name of Participants (Optional):</Typography>
//             <Box sx={{ borderBottom: '1px dotted black', flex: 1, ml: 2, mb: 0.5 }} />
//           </Box>
...
//           <Box display="flex" alignItems="flex-end" sx={{ mt: 5 }}>
//             <Typography variant="body2" fontWeight="bold">Name/Sign/Stamp/Date:</Typography>
//             <Box sx={{ borderBottom: '1px solid black', width: '300px', ml: 2, mb: 0.5 }} />
//           </Box>
//         </Box>
